  ...
  return (
    <>
      <style>{`
        ...
        /* Main Panel - Complete White Theme */
        .jf-panel {
          position: fixed;
          bottom: 112px;
          right: 24px;
        ...
        .jf-messages::-webkit-scrollbar { width: 6px; }
        .jf-messages::-webkit-scrollbar-track { background: #f8f9fa; border-radius: 3px; }
        .jf-messages::-webkit-scrollbar-thumb { background: #d1d5db; border-radius: 3px; }
        .jf-messages::-webkit-scrollbar-thumb:hover { background: #9ca3af; }
        ...
        .jf-bot strong { color: #1f2937; font-weight: 700; }
        .jf-bot em { color: #4b5563; font-style: italic; }
        .jf-user {
          background: #1f2937;
          color: #ffffff;
        ...
        .jf-list-num { color: #6b7280; font-weight: 700; flex-shrink: 0; min-width: 22px; }
        ...
        .jf-send:active { transform: scale(0.95); }
        .jf-send:disabled { opacity: 0.4; cursor: not-allowed; transform: none; }
        .jf-send svg path {
          stroke: #ffffff;
        }
        ...
        @media (max-width: 480px) {
          ...
          .jf-fab   { right: 16px; bottom: 16px; }
          .jf-ring  { right: 16px; bottom: 16px; }
          .jf-speech { font-size: 11px; padding: 6px 12px; white-space: nowrap; }
        }
      `}</style>
      ...
      <div className="jf">
        ...
        >
          {open ? (
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              <path d="M18 6L6 18M6 6l12 12" stroke="#1f2937" strokeWidth="2.5" strokeLinecap="round"/>
            </svg>
          ) : (
            <>
              <img src="/mascot.png" alt="Chat" className="jf-fab-img" />
