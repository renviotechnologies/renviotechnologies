...
export default function AnnouncementBar() {
    ...
    return (
        <div className="relative bg-gradient-to-r from-[#9f02e7] via-[#9200b3] to-[#c102e7] text-white overflow-hidden h-10 flex items-center z-50">
            {/* Gradient Overlay for smooth edges */}
            <div className="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-[#9200b3] to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-[#b502e7] to-transparent z-10 pointer-events-none" />
