                ...
                <div className="flex flex-col md:flex-row gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-neutral-500 font-body leading-relaxed">
                            With 13+ years transforming brands across real estate, SaaS, and automotive, I founded Renvio to bridge the gap between creative ambition and data reality. We are the partners I always wished I had.
                        </p>
                    </motion.div>
                </div>
            </div>
